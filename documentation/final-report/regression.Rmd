---
title: "Regression Modeling and Analysis"
author: "Andrew Chung"
date: "2025-05-15"
output: pdf_document
---
...
BTRY 4100 Final Project -- Linear Regression Modeling and Analysis.
...
## Ordinary Least Squares (OLS) Model -- Ridership
...
## Ordinary Least Squares (OLS) Model -- Log-Transformed Ridership
...
I sought to include an interaction term to better capture between-predictor effects (for any that exist) and improve upon the model's predictive power.
...
To maintain model parsimony, I decided to limit the addition of interaction terms to 1; clearly, `additional_train_time:reliability_PC` appears most significant and improves predictive power most.
...
### Adoption of HC3 (Heteroskedascity-Constant) Robust SEs to Control for Hetetoskedascity
